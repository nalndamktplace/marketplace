...
const CreateNftPage = props => {
	...
	const [FormInput, setFormInput] = useState({ name: '', author: '', cover: null, preview: null, book: null, genres: [], price: '', pages: '', publication: '', attributes: [], synopsis: '', language: '', published: '' })
