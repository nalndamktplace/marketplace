...
function BookReaderPage() {
  ...
  const [renderAnnotationItems, setRenderAnnotationItems] = useState([]);
  ...
  useEffect(() => {
    ...
    console.log(bookURL, navParams.book.preview, "bookURLbookURL");
    try {
  ...
  const handleAnnotationColorSelect = (color: any) => {
    ...
    if (
      ...
      console.log(
        annotationSelection,
        "annotationSelectionannotationSelectionannotationSelection"
      );
  ...
  return (
    <div className="max-w-full mx-auto text-black">
      ...
      <>
        ...
        {/* // AnnotationPanel need to be added in side bar */}
        <SideDrawer
          show={annotaionPanel}
        ...
        <AnnotationPanel
          preview={Preview}
          setRenderAnnotationItems={setRenderAnnotationItems}
