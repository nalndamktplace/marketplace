function PrivacyPage() {
  return (
    <div>
      <h1 className="container py-10 text-3xl font-semibold text-center text-primary">
        Privacy Policy
      </h1>
      <div className="container flex flex-col gap-4 text-black">
        ...
        <ul className="">
          ...
          <li>
            <p>
              <strong>Application</strong> refers to nalnda, the software
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to nalnda.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to nalnda, accessible from{" "}
              <a
                href="https://nalnda.com/"
        ...
        <h2 className="font-semibold text-primary">Children's Privacy</h2>
        <p>
        ...
        <h2 className="font-semibold text-primary">Links to Other Websites</h2>
        <p>
        ...
        <h2 className="font-semibold text-primary">Contact Us</h2>
        <p>
