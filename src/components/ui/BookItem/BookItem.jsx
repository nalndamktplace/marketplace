    ...
    return (
        <div className='book-item' onClick={onOpen} data-layout={layout}>
            ...
            <div className="book-item__data">
                <div className='book-item__data__price typo__body typo__body--2 utils__d__flex utils__align__center'><USDCIcon width={20} height={20} stroke="currentColor"/>&nbsp;{book.price}</div>
